...
local rage = main:create_tab('⚔️ Combat', 'rbxassetid://6031094670')
local detectionstab = main:create_tab('🔍 Detection', 'rbxassetid://6031154871')
local visuals = main:create_tab('👁️ Visuals', 'rbxassetid://6031075938')
local pl = main:create_tab('👤 Player', 'rbxassetid://6031280882')
local sw = main:create_tab('🗡️ Sword', 'rbxassetid://6035047377')
