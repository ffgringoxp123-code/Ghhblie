...
local rage = main:create_tab('Combat', 'rbxassetid://6031091003')
local detectionstab = main:create_tab('Detection', 'rbxassetid://6031075931')
local visuals = main:create_tab('Visuals', 'rbxassetid://6031071053')
local pl = main:create_tab('Player', 'rbxassetid://6031265976')
local sw = main:create_tab('Sword', 'rbxassetid://6035047409')
