...
function Library.SendNotification(settings)
    ...
    AccentBar.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
...
function Library:create_ui()
    ...
    Container.BorderColor3 = Color3.fromRGB(0, 170, 255)
    Container.AnchorPoint = Vector2.new(0.5, 0.5)
    Container.Name = 'Container'
    Container.BackgroundTransparency = 0.05000000074505806
    Container.BackgroundColor3 = Color3.fromRGB(0, 170, 255)
    ...
    Handler.BorderColor3 = Color3.fromRGB(0, 170, 255)
    Handler.Size = UDim2.new(0, 680, 0, 460)
    Handler.BorderSizePixel = 0
    Handler.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
    ...
    Tabs.BorderColor3 = Color3.fromRGB(0, 170, 255)
    Tabs.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
    ...
    ClientName.BorderColor3 = Color3.fromRGB(0, 170, 255)
    ClientName.TextSize = 16
    ClientName.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
    ClientName.Parent = Handler
    
    local UIGradient = Instance.new('UIGradient')
    UIGradient.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(150, 150, 150)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 90, 255)),
    ...
    Icon.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
    Icon.Parent = Handler
    ...
    task.spawn(function()
        local frames = {'rbxassetid://129430365420845', 'rbxassetid://129430365420845', 'rbxassetid://129430365420845'}
        local index = 0
    ...
    Minimize.BorderColor3 = Color3.fromRGB(0, 170, 255)
    Minimize.Text = ''
    ...
    Minimize.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
        ...
        for index, object in Tabs:GetChildren() do
            ...
            if object.BackgroundTransparency ~= 1 then
                ...
                TweenService:Create(object.TextLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                    ...
                    TextColor3 = Color3.fromRGB(0, 90, 255)
                }):Play()
                ...
                TweenService:Create(object.Icon, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                    ...
                    ImageColor3 = Color3.fromRGB(0, 90, 255)
                }):Play()
            end
        end
    end
    ...
    function self:create_tab(title: string, icon: string, visible: boolean)
        ...
        Tab.BorderColor3 = Color3.fromRGB(0, 170, 255)
        Tab.Text = ''
        ...
        TextLabel.TextColor3 = Color3.fromRGB(0, 90, 255)
        ...
        TextLabel.BorderColor3 = Color3.fromRGB(0, 170, 255)
        TextLabel.TextSize = 13
        TextLabel.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
        ...
        LeftSection.BorderColor3 = Color3.fromRGB(0, 170, 255)
        LeftSection.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
        ...
        RightSection.BorderColor3 = Color3.fromRGB(0, 170, 255)
        RightSection.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
        ...
        function TabManager:create_module(settings: any)
            ...
            Module.BorderColor3 = Color3.fromRGB(0, 170, 255)
            ...
            Header.BorderColor3 = Color3.fromRGB(0, 170, 255)
            Header.Text = ''
            ...
            Header.TextSize = 14
            Header.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
...
LockButton.Image = 'rbxassetid://129430365420845'
...
setModuleInteractable(true)
    ...
    LockButton.MouseButton1Click:Connect(function()
        ...
        if ModuleManager._locked then
            ...
            ModuleName.TextColor3 = Color3.fromRGB(0, 170, 255)
            ...
            ModuleName.BorderColor3 = Color3.fromRGB(0, 170, 255)
            ModuleName.TextSize = 13
            ModuleName.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
            ...
            Description.BorderColor3 = Color3.fromRGB(0, 170, 255)
            Description.TextSize = 10
            Description.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
            ...
            Circle.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
            ...
            Keybind.BorderColor3 = Color3.fromRGB(0, 170, 255)
            ...
            Divider.BorderColor3 = Color3.fromRGB(0, 170, 255)
            ...
            Divider.BackgroundColor3 = Color3.fromRGB(0, 120, 255)
            ...
            Options.BorderColor3 = Color3.fromRGB(0, 170, 255)
            Options.Size = UDim2.new(0, 241, 0, 8)
            Options.BorderSizePixel = 0
            Options.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
            ...
            function ModuleManager:change_state(state: boolean)
                ...
                if self._state then
                    ...
                    TweenService:Create(Circle, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(0, 90, 255),
    ...
    Label.TextColor3 = Color3.fromRGB(0, 90, 255)
    ...
    WhiteGrad.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
    ...
    BlackGrad.BackgroundColor3 = Color3.fromRGB(0, 170, 255)
    ...
    Picker.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
    ...
    HueStrip.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
    ...
    HueCursor.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
    ...
    HueCursorStroke.Color = Color3.fromRGB(0, 170, 255)
    ...
    return ColorpickerManager
            ...
            function ModuleManager:create_textbox(settings: any)
                ...
                Textbox.TextColor3 = Color3.fromRGB(0, 90, 255)
                ...
                Textbox.TextSize = 10
                Textbox.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
            ...
            function ModuleManager:create_checkbox(settings: any)
                ...
                Checkbox.TextColor3 = Color3.fromRGB(0, 170, 255)
                ...
                TitleLabel.TextColor3 = Color3.fromRGB(0, 90, 255)
                ...
                KeybindBox.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
                ...
                Box.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
                Box.Parent = Checkbox
                ...
                Fill.BorderColor3 = Color3.fromRGB(0, 170, 255)
                Fill.Name = "Fill"
                Fill.BorderSizePixel = 0
                Fill.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
                Fill.Parent = Box
            ...
            function ModuleManager:create_divider(settings: any)
                ...
                if settings and settings.showtopic then
                    local TextLabel = Instance.new('TextLabel')
                    TextLabel.FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.SemiBold, Enum.FontStyle.Normal)
                    TextLabel.TextColor3 = Color3.fromRGB(0, 90, 255) -- 154, 182, 255
                ...
                if not settings or settings and not settings.disableline then
                    ...
                    Divider.BackgroundColor3 = Color3.fromRGB(0, 90, 255) -- White color
                    Divider.BorderSizePixel = 0
                    Divider.Name = 'Divider'
                    ...
                    Gradient.Color = ColorSequence.new({
                        ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 90, 255)),  -- Start with white
                        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 90, 255)), -- Keep it white in the middle
            ...
            function ModuleManager:create_slider(settings: any)
                ...
                Slider.TextSize = 14;
                Slider.TextColor3 = Color3.fromRGB(0, 170, 255)
                ...
                Drag.BorderColor3 = Color3.fromRGB(0, 170, 255)
                ...
                Drag.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
                Drag.Parent = Slider
                ...
                Value.TextColor3 = Color3.fromRGB(0, 90, 255)
                ...
                Value.BorderColor3 = Color3.fromRGB(0, 170, 255)
                Value.TextSize = 10
                Value.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
                Value.Parent = Slider
            ...
            function ModuleManager:create_dual_slider(settings: any)
                ...
                MinCircle.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
                ...
                MaxCircle.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
            ...
            function ModuleManager:create_dropdown(settings: any)
                ...
                Dropdown.TextColor3 = Color3.fromRGB(0, 170, 255)
                Dropdown.BorderColor3 = Color3.fromRGB(0, 170, 255)
                Dropdown.Text = ''
                ...
                CurrentOption.TextColor3 = Color3.fromRGB(0, 90, 255)
                ...
                CurrentOption.BorderColor3 = Color3.fromRGB(0, 170, 255)
                CurrentOption.TextSize = 10
                CurrentOption.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
                ...
                Arrow.BorderColor3 = Color3.fromRGB(0, 170, 255)
                Arrow.AnchorPoint = Vector2.new(0, 0.5)
                Arrow.Image = 'rbxassetid://129430365420845'
                Arrow.BackgroundTransparency = 1
                Arrow.Position = UDim2.new(0.9100000262260437, 0, 0.5, 0)
                Arrow.Name = 'Arrow'
                Arrow.Size = UDim2.new(0, 8, 0, 8)
                Arrow.BorderSizePixel = 0
                Arrow.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
                Arrow.Parent = Header
                
                local Options = Instance.new('ScrollingFrame')
                Options.ScrollBarImageColor3 = Color3.fromRGB(0, 170, 255)
                Options.Active = true
                ...
                if #settings.options > 0 then
                    ...
                    for index, value in settings.options do
                        ...
                        Option.TextColor3 = Color3.fromRGB(0, 90, 255)
                        Option.BorderColor3 = Color3.fromRGB(0, 170, 255)
                        ...
                        Option.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
            ...
            function ModuleManager:create_feature(settings)
                ...
                KeybindBox.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
                KeybindBox.TextColor3 = Color3.fromRGB(0, 90, 255)
                ...
                if not settings.disablecheck then
                    ...
                    Checkbox.BackgroundColor3 = checked and Color3.fromRGB(0, 90, 255) or Color3.fromRGB(20, 20, 20)
                    Checkbox.Text = ""
...
local rage = main:create_tab('Combat', 'rbxassetid://129430365420845')
local detectionstab = main:create_tab('Detection', 'rbxassetid://129430365420845')
local visuals = main:create_tab('Visuals', 'rbxassetid://129430365420845')
local pl = main:create_tab('Player', 'rbxassetid://129430365420845')
local sw = main:create_tab('Sword', 'rbxassetid://129430365420845')
...
local function create_mobile_button(name, position_y, color)
    ...
    text.TextSize = 16
    text.TextColor3 = Color3.fromRGB(0, 90, 255)
    text.ZIndex = 3
    text.Parent = button
        ...
        if System.__properties.__is_mobile then
            if value then
                if not System.__properties.__mobile_guis.triggerbot then
                    local triggerbot_mobile = create_mobile_button('Trigger', 0.7, Color3.fromRGB(0, 90, 255))
                    ...
                    triggerbot_mobile.button.InputEnded:Connect(function(input)
                        if input.UserInputType == Enum.UserInputType.Touch and not was_dragged then
                            ...
                            if System.__properties.__triggerbot_enabled then
                                ...
                                triggerbot_mobile.text.TextColor3 = Color3.fromRGB(0, 90, 255)
                            else
...
local function create_curve_selector_mobile()
    ...
    main_stroke.Color = Color3.fromRGB(0, 120, 255)
    ...
    for i, curve_data in ipairs(CURVE_TYPES) do
        ...
        indicator.BackgroundColor3 = Color3.fromRGB(0, 90, 255)
        ...
        if System.__properties.__is_mobile then
            if state then
                if not System.__properties.__mobile_guis.manual_spam then
                    local manual_spam_mobile = create_mobile_button('Spam', 0.8, Color3.fromRGB(0, 90, 255))
                    ...
                    manual_spam_mobile.button.InputEnded:Connect(function(input)
                        if input.UserInputType == Enum.UserInputType.Touch and not manual_was_dragged then
                            ...
                            if System.__properties.__manual_spam_enabled then
                                ...
                                manual_spam_mobile.text.TextColor3 = Color3.fromRGB(0, 90, 255)
                            else
...
function Byte_Library.Korblox(Character)
    ...
    if not Right_Leg:FindFirstChild('KorbloxMesh') then
        ...
        Korblox.MeshId = 'rbxassetid://129430365420845'
        Korblox.TextureId = 'rbxassetid://129430365420845'
...
local ability_esp = {
    __config = {
        ...
        text_color = Color3.fromRGB(0, 90, 255),
        stroke_color = Color3.fromRGB(0, 170, 255),
...
local ball_velocity = {
    __config = {
        ...
        colors = {
            ...
            text_primary = Color3.fromRGB(0, 90, 255),
            text_secondary = Color3.fromRGB(170, 170, 170),
            accent_green = Color3.fromRGB(0, 90, 255),
            accent_orange = Color3.fromRGB(0, 90, 255),
...
function Plasma.create_trails(ball)
    ...
    for i = 1, PlasmaTrails.NumTrails do
        ...
        trail.Texture = "rbxassetid://129430365420845"
...
local MadeInHeaven = {
    ...
    Acceleration = 180,
    CurrentTime = 12,
    SoundId = "rbxassetid://129430365420845",
    SoundVolume = 1.5,
...
function MadeInHeaven:startUpdateLoop()
	...
	local hitSoundIds = {
		Medal = "rbxassetid://129430365420845",
		Fatality = "rbxassetid://129430365420845",
		Skeet = "rbxassetid://129430365420845",
		Switches = "rbxassetid://129430365420845",
		["Rust Headshot"] = "rbxassetid://129430365420845",
		["Neverlose Sound"] = "rbxassetid://129430365420845",
		Bubble = "rbxassetid://129430365420845",
		Laser = "rbxassetid://129430365420845",
		Steve = "rbxassetid://129430365420845",
		["Call of Duty"] = "rbxassetid://129430365420845",
		Bat = "rbxassetid://129430365420845",
		["TF2 Critical"] = "rbxassetid://129430365420845",
		Saber = "rbxassetid://129430365420845",
		Bameware = "rbxassetid://129430365420845",
	}
